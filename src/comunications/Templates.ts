...
Since we have limited bandwidth, we will not be able to process your request currently. 

We hope you understand our limitations.:)

Warmth and Love,
RHA`;
    public static incompleteInformation: string = `
Hi,

We hope you’re safe and well. Thank you for reaching out to us - we have received your request.
However, the information shared is incomplete. We request you to kindly re-submit the form with all required details for us to ensure we can deliver the help to your loved ones :)
